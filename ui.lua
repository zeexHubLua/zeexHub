--[[
    UI.LUA - ТОЛЬКО ИНТЕРФЕЙС (БЕЗ ЛОГИКИ)
    Все кнопки просто вызывают заглушки
]]
...
-- КНОПКИ MACRO (просто кнопки, без логики)
local function createMacroButton(text, x, y, parent)
    ...
    -- ПОКА ПРОСТО ЗАГЛУШКА (ПЕЧАТАЕТ В КОНСОЛЬ)
    btn.MouseButton1Click:Connect(function()
        print("Кнопка нажата:", text)
    end)
...
print("✅ UI ЗАГРУЖЕН (только интерфейс)")
print("📌 Кнопки пока ничего не делают")
